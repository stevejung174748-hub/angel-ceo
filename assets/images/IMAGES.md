# Angel CEO (angel-ceo) — 이미지 교체 & AI 생성 가이드

파일명만 맞추면 HTML·CSS 수정 없이 교체 가능합니다.  
JungPM 사이트와 **구도·색감·소품**을 다르게 — Angel CEO만의 **로즈·플럼·라일락** 큐레이션 무드.

---

## 사이트 공통 비주얼 방향

**브랜드:** Angel CEO — 밤문화 정보 허브 (고급·차분·큐레이션)
...
| # | 파일명 | 용도 |
|---|--------|------|
| 1 | `hero-angel-bg.png` | 홈 히어로 배경 |
| 2 | `hero-angel.png` | 홈 히어로 우측 카드 |
| 3 | `angel-banner-jeju-room.png` | 제주 룸싸롱 신호등 |
| 4 | `angel-banner-jeju-nightlife.png` | 제주 유흥 미술관 |
| 5 | `angel-banner-haeundae-hoppa.png` | 해운대 호빠 |
| 6 | `angel-banner-songpa-karaoke.png` | 송파 노래방·가라오케 |
| 7 | `angel-banner-gangnam-hoppa.png` | 강남 호빠 |
...
Angel CEO 브랜드를 상징하는 **‘큐레이터’** 느낌 — 우아하고 차분.  
...
## 4. angel-banner-jeju-nightlife.png
...
## 5. angel-banner-haeundae-hoppa.png
...
## 6. angel-banner-songpa-karaoke.png
...
## 7. angel-banner-gangnam-hoppa.png
...
- `angel-detail-jeju-room.png` (820×460, 16:9에 가깝게)
